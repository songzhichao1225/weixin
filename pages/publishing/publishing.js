...
Page({
  ...
  sportsList: function () {
    wx.navigateTo({
      url: "/pages/sportsList/sportsList"
    })
  },
  ...
  venues: function (e) {
    ...
    if (e.currentTarget.dataset == undefined) {
      ...
      wx.navigateTo({
        url: "/generalization/map/map?sportid=" + e.currentTarget.dataset.sportid + '&sporttype=' + e.currentTarget.dataset.sporttype
      })
    }
  },
  ...
  onShow: function () {
    ...
    } else if (wx.getStorageSync('sportIdF') !== '') {
      this.onKO()
      this.setData({
